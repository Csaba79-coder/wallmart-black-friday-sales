...
def decision_tree_classification():
    ...
    majd Decision Tree osztályozást hajt végre a Gender előrejelzésére.
    """
    # Adatok betöltése
    ...
    if data_sample is not None:
        ...
        model = DecisionTreeClassifier(random_state=42, max_depth=5)  # Decision Tree modell létrehozása
